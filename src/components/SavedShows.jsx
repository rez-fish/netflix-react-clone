...
const SavedShows = () => {
  ...
  useEffect(() => {
    onSnapshot(doc(db, 'users', 'test@test.com'), (doc) => {
          ...
          {movies?.map((item, id) => (
            ...
            >
              <img
                ...
                alt={item?.title}
              />
              <div className='absolute top-0 left-0 w-full h-full  opacity-0 hover:bg-black/80 hover:opacity-100 text-white transition-all'>
